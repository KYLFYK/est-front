...
class DeveloperCabinetStore {
    ...
    async fetch() {
        ...
        this.initialData = {
            account: {
                id: res.data.id,
                src: res.data.developerProperty.logo ? res.data.developerProperty.logo : "http://s3.dtln.ru:80/mp-data/2fe95d2797f26d5f6f0b7b63d5604771.jpg",
                profileForm: {
                    name: res.data.developerProperty.name,
                    type: res.data.developerProperty.type ? res.data.developerProperty.type : '',
                    address: res.data.developerProperty.address ? res.data.developerProperty.address : '',
                    phone: res.data.developerProperty.phone[0].value ? res.data.developerProperty.phone[0].value : '',
                    email: res.data.email,
                    site: res.data.developerProperty.site ? res.data.developerProperty.site :'',
                    description: res.data.developerProperty.description ? res.data.developerProperty.description :'',
                },
            },
            setting: {
                phoneNumber: res.data.developerProperty.phone[0].value ? res.data.developerProperty.phone[0].value : '',
            ...
            legal: {
                ...
                registeringAuthorityLocated: res.data.developerProperty.registeringAuthorityLocated,
                registrationAuthorityAddress: res.data.developerProperty.registrationAuthorityAddress,
                registrationAuthorityName: res.data.developerProperty.registrationAuthorityName,
