...
class DeveloperNotificationsStore {
    ...
    initialData = {
        notifications: [
            {
                id: '1', date: '22.03.2021',
                time: '17:30', message: 'Автоматическое возобновление публикаций выключено', read: false
            },
            {
                id: '2',
                date: '22.03.2021',
                time: '15:30',
                message: 'Автоматическое возобновление публикаций выключеноАвтоматическое возобновление публикаций выключ',
                read: false
            },
            {
                id: '3', date: '21.03.2021',
                time: '13:30', message: 'Автоматическое возобновление публикаций выключено', read: true
            },
            {
                id: '4', date: '20.03.2021',
                time: '11:30', message: 'Автоматическое возобновление публикаций выключено', read: true
            },
        ]
    }
