...
const LegalPurityFounders: React.FC<Props> = observer(({ onPublish, onPrevTab, objectType }) => {
    ...
    const onChangeCurrentFounder = (value: string) => {
        if (value === FoundersTypes.PAIR)
            setValues({ ...values, currentFounder: { ...values.currentFounder, founderType: value as FoundersTypes, secondFouderName: "" } })
        else
            setValues({ ...values, currentFounder: { ...values.currentFounder, founderType: value as FoundersTypes, secondFouderName: undefined } })
    }

    const onChangePrevFounder = (value: string) => {
        if (value === FoundersTypes.PAIR)
            setValues({ ...values, previousFounder: { ...values.previousFounder, founderType: value as FoundersTypes, secondFouderName: "" } })
        else
            setValues({ ...values, previousFounder: { ...values.previousFounder, founderType: value as FoundersTypes, secondFouderName: undefined } })
    }

    const onChangePrevFirstFounderName = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, previousFounder: { ...values.previousFounder, firstFounderName: event.target.value } })
    }
    const onChangePrevSecondFounderName = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, previousFounder: { ...values.previousFounder, secondFouderName: event.target.value } })
    }

    const onChangeCurrentFirstFounderName = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, currentFounder: { ...values.currentFounder, firstFounderName: event.target.value } })
    }
    const onChangeCurrentSecondFounderName = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, currentFounder: { ...values.currentFounder, secondFouderName: event.target.value } })
    }


    const onChangeCurrentCadastralNumber = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, currentFounder: { ...values.currentFounder, cadastralNumber: event.target.value } })
    }

    const onChangePrevCadastralNumber = (event: React.ChangeEvent<HTMLInputElement>) => {
        setValues({ ...values, previousFounder: { ...values.previousFounder, cadastralNumber: event.target.value } })
    }

    const onChangePrevFounderStartDate = (value: Date) => {
        setValues({ ...values, previousFounder: { ...values.previousFounder, ownershipFrom: value } })
    }
    const onChangePrevFounderEndDate = (value: Date) => {
        setValues({ ...values, previousFounder: { ...values.previousFounder, ownershipTo: value } })
    }

    const onChangeCurrentFounderStartDate = (value: Date) => {
        setValues({ ...values, currentFounder: { ...values.currentFounder, ownershipFrom: value } })
    }
