...
type AddGuideType={
    onCreate:(type_en:string,type_ru:string,value:string,visionObject:Array<string>)=>void
    onExit:()=>void
}

const AddGuide:FC<AddGuideType> = ({onCreate,onExit}) => {
        ...
        <div >
            ...
            <div style={{display: 'flex',marginTop:'10px'}}>
                <div style={{marginRight:"10px"}}>
                    <BaseButton
                        type={"secondary"}
                        onClick={()=>onCreate(type_en,type_ru,value,forObjects)}
                        isActive
                    >
                        Сохранить
                    </BaseButton>
