...
export const OfferNews = () => {
    ...
    const [messageNews,setMessageNews]=useState('Спасибо что подписались на новости')
                ...
                >
                    {
                        messageNews === 'Спасибо что подписались на новости'
                            ?<svg  width="340" height="159" viewBox="0 0 340 159" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M101 33C101 29.6863 103.686 27 107 27H256C259.314 27 262 29.6863 262 33V120H101V33Z" fill="#CAD1DA"/>
                                <path d="M227.6 120H262L253.782 152.49C253.557 153.378 252.759 154 251.843 154H221.569C220.265 154 219.31 152.773 219.63 151.51L227.6 120Z" fill="#90CAF9"/>
                                <path d="M101.4 120H135L126.976 152.48C126.755 153.373 125.954 154 125.034 154H95.5543C94.2554 154 93.3011 152.781 93.6126 151.52L101.4 120Z" fill="#90CAF9"/>
                                <path d="M143.4 120H177L168.976 152.48C168.755 153.373 167.954 154 167.034 154H137.554C136.255 154 135.301 152.781 135.613 151.52L143.4 120Z" fill="#90CAF9"/>
                                <path d="M185.4 120H219L210.976 152.48C210.755 153.373 209.954 154 209.034 154H179.554C178.255 154 177.301 152.781 177.613 151.52L185.4 120Z" fill="#CAD1DA"/>
