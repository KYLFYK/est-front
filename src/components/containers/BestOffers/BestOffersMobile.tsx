...
export const BestOffersMobile: FC<BestOffersType> = observer(
  ({ tagsButton }) => {
    ...
    const [activeFilter, setActiveFilter] = useState<Array<boolean>>([
      false,
      false,
      false,
      false,
      ...
      <div className={css.offers}>
        <HeadLine title={"Лучшие предложения"}>
          ...
          <div className={css.block}>
            {store.initialData.bestOffers !== null &&
              store.initialData.bestOffers.length > 0 &&
