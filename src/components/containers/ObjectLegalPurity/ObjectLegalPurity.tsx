        ...
        <div className={s.container}>
            <HeadLine title="Юридическая чистота">
                <div className={s.infoBlock}>
                    <Advantage title="Риски" text={legalPurityData && legalPurityData.risks ? "Да" : "Нет"}
                               className={s.iconItem}>
                        <ExclamationMarkIcon/>
                    </Advantage>
                    <Advantage title="Обременения" text={legalPurityData && legalPurityData.encumbrances ? "Да" : "Нет"}
                               className={s.iconItem}>
                        <EncumbrancesIcon/>
                    </Advantage>
                </div>
