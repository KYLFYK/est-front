...
import LegalPurityRecomendationsTab
    from "../../tabs/LegalPurity/components/Recomendations/LegalPurityRecomendationsTab";
            ...
            <Typography size={'subheader'} weight="bold">
                ...
                </div>
                {
                    ...
                    <InfoDeveloperMobile title={'Общие сведения'}>
                        <LegalPurityGeneralTab data={legalPurityData?.tabsData && legalPurityData?.tabsData.general}/>
                    </InfoDeveloperMobile>
                }
                {
                    ...
                    <InfoDeveloperMobile title={'Собственники'}>
                        <LegalPurityFoundersTab data={legalPurityData?.tabsData &&  legalPurityData.tabsData.founders}/>
                    </InfoDeveloperMobile>
                }
                {
                    ...
                    <InfoDeveloperMobile title={'Обременения'}>
                        <LegalPurityEncumbrancesTab data={legalPurityData?.tabsData && legalPurityData.tabsData.encumbrances}/>
                    </InfoDeveloperMobile>
                }
                {
                    ...
                    <InfoDeveloperMobile title={'Рекомендации'}>
                        <LegalPurityRecomendationsTab data={legalPurityData?.tabsData && legalPurityData?.tabsData.recomendations}/>
                    </InfoDeveloperMobile>
                }
        </div>
    );
