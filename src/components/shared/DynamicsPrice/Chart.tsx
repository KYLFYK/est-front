...
export const Chart: React.FC<Props> = ({heightValue,language}) => {

    let koef = 1;

     const data = [
        {name: 'Январь 2018', price: 50000*koef},
        {name: 'Июль 2018', price: 55000*koef},
        {name: 'Январь 2019', price: 56000*koef},
        {name: 'Июль 2019', price: 61000*koef},
        {name: 'Январь 2020', price: 62000*koef},
        {name: 'Июль 2020', price: 67000*koef},
        {name: 'Январь 2021', price: 68000*koef},
        {name: 'Июль 2021', price: 71000*koef},
    ]
    const lowResolutionData = [
        {name: 'Янв.18', price: 50000*koef},
        {name: 'Июл.18', price: 55000*koef},
        {name: 'Янв.19', price: 56000*koef},
        {name: 'Июл.19', price: 61000*koef},
        {name: 'Янв.20', price: 62000*koef},
        {name: 'Июл.20', price: 67000*koef},
        {name: 'Янв.21', price: 68000*koef},
        {name: 'Июл.21', price: 71000*koef},
    ]
    ...
    const customTickX = ({ x, y, payload }: {x: number, y: number, payload: any}) => {
        return (
            <svg x={x-30} y={y} width="100" height="50" viewBox="0 0 100 50" fill="none" xmlns="http://www.w3.org/2000/svg">
