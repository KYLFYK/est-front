    ...
    return (
      <>
        <svg className={s.icon} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M32 23C32 22.0807 31.8189 21.1705 31.4672 20.3212C31.1154 19.4719 30.5998 18.7003 29.9497 18.0503C29.2997 17.4002 28.5281 16.8846 27.6788 16.5328C26.8295 16.1811 25.9193 16 25 16C24.0807 16 23.1705 16.1811 22.3212 16.5328C21.4719 16.8846 20.7003 17.4002 20.0503 18.0503C19.4002 18.7003 18.8846 19.4719 18.5328 20.3212C18.1811 21.1705 18 22.0807 18 23" stroke="#1A4862" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </>
    )
  };