    ...
    return (
      <>
        <svg className={s.icon} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M32 20.5C32.5523 20.5 33 20.0523 33 19.5C33 18.9477 32.5523 18.5 32 18.5C31.4477 18.5 31 18.9477 31 19.5C31 20.0523 31.4477 20.5 32 20.5Z" fill="#1A4862"/>
          <path d="M28 20.5C28.5523 20.5 29 20.0523 29 19.5C29 18.9477 28.5523 18.5 28 18.5C27.4477 18.5 27 18.9477 27 19.5C27 20.0523 27.4477 20.5 28 20.5Z" fill="#1A4862"/>
          ...
          <path d="M18 27.5C18.5523 27.5 19 27.0523 19 26.5C19 25.9477 18.5523 25.5 18 25.5C17.4477 25.5 17 25.9477 17 26.5C17 27.0523 17.4477 27.5 18 27.5Z" fill="#1A4862"/>
          <path d="M22 27.5C22.5523 27.5 23 27.0523 23 26.5C23 25.9477 22.5523 25.5 22 25.5C21.4477 25.5 21 25.9477 21 26.5C21 27.0523 21.4477 27.5 22 27.5Z" fill="#1A4862"/>
